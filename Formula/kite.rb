# Generated with JReleaser 1.21.0 at 2025-12-21T09:13:16.676832405Z

class Kite < Formula
  desc "Multi-cloud Infrastructure as Code CLI"
  homepage "https://github.com/kitecorp/kite"
  url "https://github.com/kitecorp/kite-cli/releases/download/0.1.0/kite-0.1.0.jar", :using => :nounzip
  version "0.1.0"
